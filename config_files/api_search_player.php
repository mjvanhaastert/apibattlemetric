...
//        $json_player = "https://api.battlemetrics.com/players/?filter[search]=/".$inputNamePlayer.'&filter[server][search]=1106399';
        $json_player = "https://api.battlemetrics.com/players/" . $inputNamePlayer;
...
//        array_push($searchIdArray,$objp->data->attributes->id);
//        array_push($searchNameArray,$objp->data->attributes->id);
//        array_push($searchCreatedAtArray,$objp->data->attributes->id);
//        array_push($searchUpdateAtArray,$objp->data->attributes->id);

        //build the tables and put all the information in it

        echo "<tr>";
        echo "<td>";
        echo $objp->data->attributes->id;
        echo "<td id='{$objp->data->attributes->name}'>";
        echo $objp->data->attributes->name;
        echo "</td>";
        echo "<td>";
        echo date('H:i:s d-M-Y',strtotime($objp->data->attributes->createdAt));
        echo "</td>";
        echo "<td>";
        echo date('H:i:s d-M-Y',strtotime($objp->data->attributes->updatedAt));
        echo "</td>";
